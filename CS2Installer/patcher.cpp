...
bool Patcher::PatchClient() {
    ...
    const char* voiceScaleBytes[2] = { "\x80\x3F\x0F\x11\x44\x24\x60\xE8\x3B\x93", "\xA0\x40\x0F\x11\x44\x24\x60\xE8\x3B\x93" }; /* valve keeps patching this signature ;< need a better signature */
